...
#define MAP_K(key) END.map<key>
#define MAP_KV(key, value) END.map<key,value>
#define GROUPBY_K(key) END.group_by<key>
#define GROUPBY_KV(key, value) END.group_by<key,value>
